...
divider:
	...
	mov rdx, r8 ; recurse through first half
	call divider

	mov rdx, [rsp]  ; change start and end for second half 
	mov rsi, r8
	inc rsi
	call divider

	mov rsi, [rsp + 16]   ; prepare registers for merge
	mov rcx, rdx
	mov rdx, r8
